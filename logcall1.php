...
//Test sql command in $sql, if errror display error msg and exit.	
...
<form name="frmLogCall" method="post" action="dispatch.php" onSubmit="return any meaningful name">
	...
	<td width="50%"><textarea name="incidentDesc" id="incidentDesc" cols="55" rows="7"></textarea></td>
	</tr>
	   <tr>
